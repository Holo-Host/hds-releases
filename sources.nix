...
# Please do not edit it manually, all changes will be overwritten.
{
  ...
  x86_64-linux.holo-dev-server-bin = builtins.fetchTarball {
    url = "https://github.com/Holo-Host/hds-releases/releases/download/2024-09-19-094255/holo-dev-server-x86_64-linux.tar.gz";
    sha256 = "1xpsf235lmhr0m715b0x6xdpryd61g3akkgp02kpc7my28iz8mwg";
  };
  aarch64-linux.holo-dev-server-bin = builtins.fetchTarball {
    url = "https://github.com/Holo-Host/hds-releases/releases/download/2024-09-19-094255/holo-dev-server-aarch64-linux.tar.gz";
    sha256 = "1422aq6c3mvbw1i8w7rcfz72ywykz817ni0997swnbjkca18msir";
  };
  aarch64-darwin.holo-dev-server-bin = builtins.fetchTarball {
    url = "https://github.com/Holo-Host/hds-releases/releases/download/2024-09-19-094255/holo-dev-server-aarch64-darwin.tar.gz";
